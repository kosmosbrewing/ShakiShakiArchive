              ...
              >
                <div>
                  ...
                  <p class="text-sm text-muted-foreground">
                    {{ parseFloat(item.productPrice).toLocaleString() }}원 ×
                    {{ item.quantity }}개
                  </p>
                </div>
          ...
          <div class="rounded-lg border bg-card p-6">
            ...
            <div class="space-y-3 text-sm">
              <div>
                ...
                <p class="font-medium" data-testid="text-shipping-name">
                  {{ order.shippingName }}
                </p>
              </div>
              <div>
                <p class="text-muted-foreground mb-1">연락처</p>
                <p class="font-medium" data-testid="text-shipping-phone">
                  {{ order.shippingPhone }}
                </p>
              </div>
              <div>
